        ...
        <section className="py-20 bg-gradient-to-b from-gray-50 to-white">
            <div className="container mx-auto px-4">
                ...
                <div className="relative">
                    {/* Timeline Line */}
                    <div className="hidden lg:block absolute left-1/2 top-0 bottom-0 w-1 bg-gradient-to-b from-blue-500 via-green-400 to-purple-500 transform -translate-x-1/2" />

                    {/* Steps Grid */}
                    <div className="grid lg:grid-cols-2 gap-y-10 lg:gap-y-22">
                        {steps.map((step, index) => {
                            ...
                            return (
                                ...
                                >
                                    {/* Step Number */}
                                    <div className={`absolute lg:absolute top-0 ${isLeft ? 'lg:right-0 lg:transform lg:translate-x-1/2' : 'lg:-left-8 lg:transform -lg:translate-x-1/2'} ${isLeft ? 'lg:mt-20' : 'lg:mt-60'} z-15`}>
                                    ...
                                    {/* Content */}
                                    <div className={`bg-white rounded-2xl p-8 shadow-lg border border-gray-100 mt-30 ${isLeft ? 'lg:mr-8' : 'lg:ml-8'} ${!isLeft ? 'lg:mt-44' : 'lg:mt-0'} relative`}>
                                        <div className={`inline-flex p-4 rounded-xl bg-gradient-to-br ${step.color} mb-10`}>
