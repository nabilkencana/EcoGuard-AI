                    ...
                    <div className="grid lg:grid-cols-2 gap-y-12">
                        {steps.map((step, index) => {
                            ...
                            return (
                                ...
                                >
                                    {/* Step Number */}
                                    <div className={`absolute lg:absolute top-0 ${isLeft ? 'lg:right-0 lg:transform lg:translate-x-1/2' : 'lg:left-0 lg:transform -lg:translate-x-1/2'} z-10`}>
                                    ...
                                    {/* Content */}
                                    <div className={`bg-white rounded-2xl p-8 shadow-lg border border-gray-100 ${isLeft ? 'lg:mr-8' : 'lg:ml-8'}`}>
                                        {/* Icon */}
